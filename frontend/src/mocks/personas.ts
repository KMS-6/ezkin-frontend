  ...
  persona_long_term_yeonseo: {
    ...
    reports: {
      ...
      30: {
        ...
        summary: '최근 30일의 수면과 HRV 변화, 피부 흐름을 함께 정리했어요.',
        observations: [
          { text: '개인 수면 평균은 6.1시간으로 기록되어 있어요.', evidence_ids: ['demo_health_baseline'] },
          { text: '개인 HRV 평균은 50.6ms로 기록되어 있어요.', evidence_ids: ['demo_health_baseline'] },
          { text: '최근 피부 스캔에서 홍조 변화가 함께 관찰됐어요.', evidence_ids: ['demo_scan_recent'] },
        ],
        patterns: [
          { text: '수면이 평소보다 짧고 HRV가 낮았던 시기에 홍조 변화가 함께 관찰됐어요.', evidence_ids: ['demo_pattern_72h'] },
        ],
        recommendations: [
          { text: '수면과 HRV가 평소보다 낮은 날의 피부 변화를 계속 함께 살펴보세요.', evidence_ids: ['demo_health_baseline', 'demo_pattern_72h'] },
        ],
        limitations: '준비된 장기 사용자 샘플에서 함께 나타난 흐름이며, 의학적 인과관계나 진단을 의미하지 않아요.',
        safety_status: 'wellness_only', generated_at: '2026-08-15T06:30:00+09:00',
      },
    },
  },
