...
export const todayBriefingMock: BriefingData = {
  ...
  metrics: [
    { id: 'sleep', label: '수면', value: '4h 12m', icon: 'sleep', description: '평소보다 짧았어요.' },
    { id: 'humidity', label: '습도', value: '28%', icon: 'humidity', description: '오늘 공기가 건조해요.' },
    { id: 'uv', label: 'UV', value: '9.0', icon: 'uv', description: '외출할 때 자외선이 강한 날이에요.' },
  ],
  syncedSources: ['수면', '활동', '날씨', 'UV'],
  syncedCount: 12,
}
